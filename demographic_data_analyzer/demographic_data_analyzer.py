...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage =  round((rich_min_workers / num_min_workers.shape[0]) * 100, 1) if num_min_workers.shape[0] > 0 else 0
    ...
    highest_earning_country_ratio = (country_salary_counts / country_total_counts).fillna(0)
    highest_earning_country = highest_earning_country_ratio.idxmax()
    highest_earning_country_percentage = round(highest_earning_country_ratio.max() * 100, 1)
